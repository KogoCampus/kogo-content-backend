...
import com.kogo.content.exception.MaxFileSizeExceededException
...
class GlobalExceptionHandler: ResponseEntityExceptionHandler() {
    ...
    fun handleDocumentNotFoundException(ex: ResourceNotFoundException): ResponseEntity<ErrorModel> {
        val errorMessage = ErrorModel(
